<x-store-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Statistiche Semplici (senza Vue) -->
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        @if(Route::has('store.orders.index'))
                        <a href="{{ route('store.orders.index') }}" class="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                            <div class="text-lg font-semibold text-green-600 mb-1">📦 Ordini</div>
                            <div class="text-sm text-gray-600">Visualizza gli ordini</div>
                        </a>
                        @endif
                        <a href="{{ route('store.profile.show') }}" class="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                            <div class="text-lg font-semibold text-purple-600 mb-1">⚙️ Profilo</div>
