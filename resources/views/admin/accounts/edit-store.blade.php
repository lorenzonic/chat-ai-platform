...
@section('title', 'Edit Store Account - ' . $store->name)
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold">Edit Store Account: {{ $store->name }}</h1>
                    <div class="flex space-x-4">
                        <a href="{{ route('admin.accounts.stores.show', $store) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded">
                            View Store
                        </a>
                ...
                <form method="POST" action="{{ route('admin.accounts.stores.update', $store) }}" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="description"
                                      id="description"
                                      rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('description', $store->description) }}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox"
                                       ...
                                       id="is_premium"
                                       value="1"
                                       {{ old('is_premium', $store->is_premium) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    ...
                    <div class="flex justify-end space-x-4">
                        <a href="{{ route('admin.accounts.stores.show', $store) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-6 py-3 rounded">
                            Cancel
                        </a>
