    ...
    <div class="no-print">
        ...
        <div class="product-info-grid">
            ...
            <div class="info-card">
                ...
                <div class="info-value">{{ $labelData['store_name'] }}</div>
            </div>

            <div class="info-card">
                <div class="info-label">Ordine</div>
                <div class="info-value font-mono">{{ $labelData['order_number'] ?: 'N/A' }}</div>
            </div>

            <div class="info-card">
                <div class="info-label">Cliente</div>
                <div class="info-value">{{ $product->client ?: '—' }}</div>
            </div>

            <div class="info-card">
                <div class="info-label">Data Consegna</div>
                <div class="info-value">{{ $product->delivery_date ? date('d/m/Y', strtotime($product->delivery_date)) : '—' }}</div>
            </div>
