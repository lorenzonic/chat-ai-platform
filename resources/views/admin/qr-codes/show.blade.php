            ...
            <div class="p-6">
                <div class="flex flex-wrap gap-1 items-center mb-6">
                    <a href="{{ route('admin.qr-codes.edit', $qrCode) }}"
                       class="bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded text-xs inline-flex items-center gap-1">
                    ...
                    <a href="{{ route('admin.qr-codes.download', $qrCode) }}"
                       class="bg-green-600 hover:bg-green-700 text-white px-2 py-1 rounded text-xs inline-flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button onclick="shareQrCode('{{ $qrCode->id }}', '{{ $qrCode->name }}', '{{ route('store.chatbot', $qrCode->store->slug) }}?ref={{ $qrCode->ref_code }}')"
                            class="bg-purple-600 hover:bg-purple-700 text-white px-2 py-1 rounded text-xs inline-flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button onclick="deleteQrCode('{{ $qrCode->id }}', '{{ $qrCode->name }}')"
                            class="bg-red-600 hover:bg-red-700 text-white px-2 py-1 rounded text-xs inline-flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                        </svg>
                        Delete
                    </button>
                    <a href="{{ route('admin.qr-codes.label', $qrCode) }}"
                       class="bg-yellow-600 hover:bg-yellow-700 text-white px-2 py-1 rounded text-xs inline-flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.qr-codes.index') }}"
                       class="text-gray-600 hover:text-gray-900 px-2 py-1 rounded text-xs inline-flex items-center gap-1 border border-gray-300">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-6">
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <dl class="space-y-3">
                                ...
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">EAN/GTIN (GS1)</dt>
                                    <dd class="text-sm font-mono text-gray-900">{{ $qrCode->ean_code ?: '—' }}</dd>
                                </div>
                                <div>
